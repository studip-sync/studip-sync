...
class ConfigCreator(object):
    ...
    def __choose_authentication_type(self):
    ...
    def __get_url_and_auth_type(self):
        selected_preset = self.__choose_preset()
        ...
        auth_key, auth_type = self.__choose_authentication_type()
        auth_data = auth_type.config_creator_get_auth_data()

        return base_url, auth_key, auth_data

    def new_config(self):
        base_url, auth_key, auth_data = self.__get_url_and_auth_type()
